...
class SimpleCsvTest extends SimpleTest
{
    ...
    public function testArrayDatasource_TypeDate()
    {
        ...
        $model = $this->arrayArray('i',
                                   array(time(), $today, '13/12/2011', array('year' => 2013, 'mon' => 12, 'mday' => 15),
            null, '',));
    ...
    public function testArrayDatasource_TypeTime()
    {
        ...
        $model = $this->arrayArray('i',
                                   array(time(), $today, '23:59', array('hours' => 22, 'minutes' => 00, 'seconds' => 00),
            null, '', '23:59:35',));
    ...
    public function testArrayDatasource_TypeTimestamp()
    {
        ...
        $model = $this->arrayArray('i',
                                   array(time(), $today, '15/12/2013 23:59', array('year' => 2011, 'mon' => 11, 'mday' => 20,
                'hours' => 22, 'minutes' => 00, 'seconds' => 00), null, '', '01/01/1991 23:59:35',));
    ...
    public function testArrayDatasource_TypeString()
    {
        ...
        $model = $this->arrayArray('i',
                                   array('umbrella', 'simpletablereport', null, '', ' ', 'kelsoncm', "line1\nline2",));
