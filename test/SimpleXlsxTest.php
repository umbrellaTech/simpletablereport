...
class SimpleXlsxTest extends SimpleTest {
    ...
    private function getTableXML_1Col($title, $count = 8) {
       return "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\r\n"
               . "<table xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\" id=\"1\" name=\"Tabela1\" displayName=\"Tabela1\" ref=\"A1:A{$count}\" totalsRowShown=\"0\">"
               . "<autoFilter ref=\"A1:A{$count}\"/>"
    ...
    public function testArrayDatasource_emptyFieldSet() {
        ...
        $renderer->setOutputFileName("/tmp/testArrayDatasource_emptyFieldSet.xlsx");
        $renderer->render($datasource, $template);
    }
    ...
    public function testArrayDatasource_emptyArray() {
        ...
        $renderer->setOutputFileName("/tmp/testArrayDatasource_emptyArray.xlsx");
        $renderer->render($datasource, $template);
    }
    ...
    public function testArrayDatasource_TypeString() {
        ...
        $renderer->setOutputFileName("/tmp/testArrayDatasource_TypeString.xlsx");
        $renderer->render($datasource, $template);
    ...
    public function testArrayDatasource_TypeInteger() {
        ...
        $renderer->setOutputFileName("/tmp/testArrayDatasource_TypeInteger.xlsx");
        $renderer->render($datasource, $template);
    ...
    public function testArrayDatasource_TypeFloat() {
        ...
        $renderer->setOutputFileName("/tmp/testArrayDatasource_TypeFloat.xlsx");
        $renderer->render($datasource, $template);
    ...
    public function testArrayDatasource_TypeDecimal() {
        ...
        $renderer->setOutputFileName("/tmp/testArrayDatasource_TypeDecimal.xlsx");
        $renderer->render($datasource, $template);
    ...
    public function testArrayDatasource_TypeMoney() {
        ...
        $renderer->setOutputFileName("/tmp/testArrayDatasource_TypeMoney.xlsx");
        $renderer->render($datasource, $template);
    ...
    public function testArrayDatasource_TypeDate() {
        ...
        $renderer->setOutputFileName("/tmp/testArrayDatasource_TypeDate.xlsx");
        $renderer->render($datasource, $template);
    ...
    public function testArrayDatasource_TypeTime() {
        ...
        $renderer->setOutputFileName("/tmp/testArrayDatasource_TypeTime.xlsx");
        $renderer->render($datasource, $template);
    ...
    public function testArrayDatasource_TypeTimestamp() {
        ...
        $renderer->setOutputFileName("/tmp/testArrayDatasource_TypeTimestamp.xlsx");
        $renderer->render($datasource, $template);
        
        $this->assertEquals($this->getTableXML_1Col($title, 9), $renderer->getTableString());
        //$this->assertEquals(
